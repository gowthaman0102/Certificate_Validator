...
`.trim();
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', background: 'rgba(0,0,0,0.6)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
      <div className="card" style={{ width: '100%', maxWidth: '720px', maxHeight: '90vh', overflowY: 'auto', margin: '0 auto', border: `2px solid ${GS.ink}`, boxShadow: '0 10px 40px rgba(0,0,0,0.3)', position: 'relative' }}>
        ...
        {loading && (
          <div style={{ textAlign: 'center', padding: '3rem 1rem' }}>
            ...
            <p style={{ fontWeight: 600, color: GS.ink }}>Running 8-Layer AI Fraud Analysis...</p>
          ...
          <>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '1.5rem', alignItems: 'center', background: '#f8f9fa', border: `1px solid ${GS.border}`, padding: '1.25rem', marginBottom: '1.25rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <div style={{ position: 'relative', width: '110px', height: '110px' }}>
                  ...
                  <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    <span style={{ fontSize: '1.4rem', fontWeight: 700, color: GS.ink, fontFamily: "'Inter', sans-serif" }}>{analysisData.risk_score}%</span>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '1.25rem', fontSize: '0.8rem', color: GS.muted, borderTop: `1px solid ${GS.mid}`, paddingTop: '0.5rem' }}>
                  <span><strong>Confidence:</strong> {analysisData.confidence_score}%</span>
                  <span><strong>Engine:</strong> Heuristic AI</span>
                  <span><strong>Time:</strong> {analysisData.execution_time_ms}ms</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: '1.25rem' }}>
              ...
              <div style={{ display: 'grid', gap: '0.4rem' }}>
                {(analysisData.reasons || []).map((reason, idx) => (
                  <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', fontSize: '0.85rem', color: GS.ink }}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ display: 'grid', gap: '0.6rem' }}>
                {Object.entries(analysisData.checks || {}).map(([key, check]) => (
                  <div key={key} style={{ background: '#ffffff', border: `1px solid ${GS.border}`, padding: '0.6rem 0.85rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '0.5rem' }}>
                    <div>
