...
const { uploadCertificate, getCertificate, getCertificateByCertNumber, getCertificatesByUniversity, getCertificatesByEmail, getCertificatesByRegisterNumber, getCertificatesByIdentity, bulkUploadCertificates, revokeCertificate, getRevocationStatus } = require('../controllers/certificateController');
